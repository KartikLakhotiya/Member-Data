...
export const EditMember = () => {
    ...
    const fetchMemberData = async () => {
        try {
            const response = await fetch(`https://member-data-6l3t.onrender.com/api/auth/find/${id}`, {
                method: 'POST'
            });
            if (response.ok) {
    ...
    const submit = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://member-data-6l3t.onrender.com/api/auth/editmember/${id}`, {
                method: 'POST',
                headers: {
