...
export function AllMembers() {
  ...
  const fetchAllMembers = async () => {
    ...
    const response = await fetch('https://member-data-6l3t.onrender.com/api/auth/allmembers', {
      method: 'POST',
      headers: {
  ...
  const deleteMember = async (id: string) => {
    ...
    try {
      const response = await fetch(`https://member-data-6l3t.onrender.com/api/auth/delete/${id}`, {
        method: 'DELETE',
      });
